...
export default function Home() {
  return (
    <div className="relative font-serif text-[#FFD700]">
      ...
      <header className="bg-[#013220]/90 text-[#FFD700] flex items-center justify-between px-10 py-6">
        <h1 className="text-xl font-bold tracking-wide">SOCIIETY</h1>
        <nav className="space-x-6 text-[#FFD700] font-sans font-semibold">
          <a href="#mission">Mission</a>
          <a href="#vision">Vision</a>
          <a href="#founder">Founder</a>
          <Link href="/pledge" className="underline hover:text-yellow-300">Join</Link>
        </nav>
      </header>

      <section id="mission" className="max-w-4xl mx-auto py-24 px-6 text-center">
        <h2 className="text-5xl text-[#FFD700] font-black mb-6 uppercase tracking-wide">Our Mission</h2>
      ...
      <section id="vision" className="max-w-4xl mx-auto py-24 px-6 text-center">
        <h2 className="text-5xl text-[#FFD700] font-black mb-6 uppercase tracking-wide">Our Vision</h2>
        <p className="text-xl font-sans leading-relaxed">
      ...
      <section id="founder" className="max-w-4xl mx-auto py-24 px-6 text-center">
        <h2 className="text-5xl text-[#FFD700] font-black mb-6 uppercase tracking-wide">From the Founder</h2>
        <p className="text-xl font-sans leading-relaxed">
      ...
      <section className="bg-[#4b0082]/90 text-[#FFD700] text-center py-24 px-6">
      ...
      <footer className="bg-black text-[#FFD700] text-center py-10 text-sm">
